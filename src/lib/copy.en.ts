...
export const COPY_EN = {
  ...
  auth: {
    ...
    loginSub: 'Sign in with your email & password',
    ...
    adminPanelSub: 'Admin accounts are granted in Supabase Auth. Contact ops, or update the role column in SQL.',
    switchToAdmin: 'Admin sign-in →',
    switchToUser: '← Customer sign-in',
  ...
  admin: {
    ...
    mfaSubtitle: 'Scan the QR code with Google Authenticator / 1Password / Authy, then enter the 6-digit code.',
    mfaStartEnroll: 'Set up 2FA',
    mfaScanHint: 'Scan with your authenticator app:',
    mfaManualEntry: 'Manual entry key',
    mfaCodeLabel: '6-digit code',
    mfaVerify: 'Verify and enter admin',
    mfaCodeInvalid: 'Enter a 6-digit numeric code',
    mfaVerifyFailed: 'Verification failed — make sure the code is the latest one',
    enrollErrorNetwork: 'Enrollment failed — try again',
    roleAgent: 'Agent Console',
    roleFx: 'Affiliate',
    roleSwitchHint: 'Viewing the admin perspective.',
    loginTitle: 'Admin sign-in',
    loginIntro: 'Enter your admin email and password. Accounts must have role=admin in Supabase Auth.',
    loginUsername: 'Email',
    loginPassword: 'Password',
    loginSubmit: 'Sign in',
    loginHint: 'Admin role required to sign in',
    loginErrorEmpty: 'Please enter username and password',
    loginErrorBad: 'Wrong username or password',
    loginErrorNotAdmin: 'This account is not an administrator',
    loginErrorNotConfirmed: 'Please confirm the registration link in your email first',
    loginErrorNetwork: 'Network error, please try again later',
    loginErrorNotConfigured: 'Server auth not configured, please contact ops',
    loginReasonNotAdmin: 'Your admin privileges were revoked',
    ...
    forbiddenReason: 'Your role cannot access this page. Contact a super admin.',
