...
export const COPY_EN = {
  ...
  checkout: {
    ...
    walletTopup: 'Top up',
    walletInsufficient: 'Insufficient balance — top up or pick another method',
    bankAccount: 'Beneficiary account',
    bankCopy: 'Copy',
    bankCopied: 'Copied',
    bankMemo: 'Include the order ID in the memo',
    bankCountdown: 'Awaiting payment',
    bankExpiresIn: 'expires in',
