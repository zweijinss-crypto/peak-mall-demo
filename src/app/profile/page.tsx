      ...
      <UserShell>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 space-y-5">
            ...
            {/* Account shortcuts — quick links to security pages */}
            <section className="bg-white rounded-xl border border-ink-100 overflow-hidden">
              <Link href="/security/password" className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-ink-50 transition-colors text-left border-b border-ink-100">
                <span className="text-[18px]" aria-hidden="true">🔑</span>
                <span className="flex-1 text-[13.5px] font-medium text-ink-900">{t.security.changePassword}</span>
                <span className="text-ink-300">→</span>
              </Link>
              <Link href="/security/fund-password" className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-ink-50 transition-colors text-left">
                <span className="text-[18px]" aria-hidden="true">🔒</span>
